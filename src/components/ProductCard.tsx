...
import WhatsAppButton from './WhatsAppButton'; // Import the WhatsApp component
  ...
  return (
    ...
    >
      ...
      <div style={{ padding: '15px' }}>
        ...
        <p style={{ color: '#888', fontSize: '0.9em', margin: '0 0 10px 0' }}>{product.category}</p>
        <p style={{ color: '#A52A2A', fontWeight: '600', fontSize: '1.2em' }}>{product.price}</p>
      </div>
    </div>
  );
};
